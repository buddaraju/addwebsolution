  ...
  constructor(props){
    ...
    loginButtons.push(
      ...
      <MuiThemeProvider>
       ...
       <MuiThemeProvider>
       <div>
          <RaisedButton label={"Register as Add Student"} primary={true} style={style} onClick={(event) => this.handleClick(event,'Addstudent')}/>
      </div>
      </MuiThemeProvider>
      </div>
    )
    this.state={
      ...
      AddstudentbuttonLabel:'Register as Add Student',
      isLogin:true
    }
  }
  componentWillMount(){
    ...
    if(this.state.isLogin){
      ...
      loginButtons.push(
        ...
        <MuiThemeProvider>
         ...
         <MuiThemeProvider>
         <div>
            <RaisedButton label={"Register as Add Student"} primary={true} style={style} onClick={(event) => this.handleClick(event,'Add student')}/>
        </div>
        </MuiThemeProvider>
        </div>
      )
